...
for(chromosome in unique(df_blocs$chr)){
  ...
  haplotype_combined = determine_haplotypes_per_chromosome(chromosome=chromosome,
                                                           start,
                                                           end,
...
* Get the summary of the results. It consists on filtering on the signicant p values.
