...
The function is designed to handle one blocs at the time. In order to apply the three test on the whole haplotypes, we need to loop over them.
...
The haplotypes are identified by an index. You need to coorespond it to the subject's ID.
...
In order to apply the above process on all your phenotypes, you need to loop over them as follow:
